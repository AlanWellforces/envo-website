...
export const SOLUTIONS: Solution[] = [
  {
    ...
    kit: [
      ...
      },
      {
        ...
        desc: 'Tool-free module-to-module and module-to-driver connectors. Not ENVO-branded — we spec it and an authorised channel supplies it in the same order.',
  ...
  },
  {
    ...
    kit: [
      ...
      },
      {
        ...
        desc: 'Protocol converter to integrate the run with site control. Not ENVO-branded — we spec it and an authorised channel supplies it in the same order.',
